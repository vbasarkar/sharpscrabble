...
let boardTest() = 
    Game.PlayingBoard().Put(Tile('W'), Coordinate(0, 0))
    Game.PlayingBoard().Put(Tile('I'), Coordinate(1, 0))
    Game.PlayingBoard().Put(Tile('L'), Coordinate(2, 0))
    Game.PlayingBoard().Put(Tile('L'), Coordinate(3, 0))
    Game.PlayingBoard().Put(Tile('Y'), Coordinate(5, 3))
    Game.PlayingBoard().Put(Tile('A'), Coordinate(5, 4))
    Game.PlayingBoard().Put(Tile('Y'), Coordinate(5, 5))
    Game.PlayingBoard().PrettyPrint()
